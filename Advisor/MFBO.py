...
from .acq_function.optimizer import QuotaCompositeOptimizer
...
class MFBO(BO):
    def __init__(self, config_space: ConfigurationSpace, method_id='unknown',
        ...
        if self.source_hpo_data is not None and not self.surrogate_type.startswith('mfes'):
            ...
            self.resource_identifiers = [-1] * len(self.source_hpo_data)
        ...
        self.acq_optimizer = QuotaCompositeOptimizer(
